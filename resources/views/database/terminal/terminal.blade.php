...
@section('title', 'Terminal / Warehouse List')
@section('content')
            <!-- Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-people"></i></span>Terminal / Warehouse list</h4>
                    <div class="right_side">
                    	<a href="{{ URL::to('/database/terminal/add') }}" class="btn btn-primary"><i class="icon-user-follow"></i>&nbsp;Add Terminal</a>
                    </div>
                </div>
                <!-- /Title -->
                                                            ...
                                                            <div class="btn-group">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div role="menu" class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{URL::to('/')}}/database/terminal/edit/{{ base64_encode($data->id) }}"><i class="fa fa-edit"></i>&nbsp;Edit</a>            
    ...
    <script type="text/javascript">
        $(document).ready(function() {
           ...
           $('.tst2').on('click',function(e){
                ...
                $.toast({
                    heading: 'Are you sure you want to delete this terminal?',
                    text: '<i class="jq-toast-icon ti-alert"></i><a href="{{ URL::to("/")}}/database/terminal/delete/'+del_data+'" class="btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;</a>',
                    position: 'top-center',
                    loaderBg:'#7a5449',
