           ...
           <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-user-follow"></i></span>Add City</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="row">
	                                        ...
	                                        <div class="col-md-6">
		                                    	<form method="post" action="{{ URL::to('/database/city/insert')}}">
		                                    		{{ csrf_field() }}
		                                        	<div class="row">
                                                        <div class="col-md-6">
                                                            <span class="label_span">PACCS Code</span><span class="required_span">*</span>
                                                            <input type="text" class="form-control form-control-sm" name="paccs_code" required>
                                                        </div>
		                                        	</div>
		                                        	<br>
		                                        	<div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="principle_code">
                                                        </div>
                                                        <div class="col-md-2 ">
                                                            <label>Type</label><span class="required_span">*</span>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio1" name="type" value="Base" class="custom-control-input" checked>
