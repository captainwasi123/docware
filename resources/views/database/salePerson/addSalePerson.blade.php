           ...
           <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="icon-user-follow"></i></span>Add Sales Person</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="row">
	                                        ...
	                                        <div class="col-md-10">
		                                    	<form method="post" action="{{ URL::to('/database/saleperson/insert')}}">
		                                    		{{ csrf_field() }}
		                                        	<div class="row">
                                                        <div class="col-md-8">
